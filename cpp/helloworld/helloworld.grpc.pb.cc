...
Greeter::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel)
  ...
  , rpcmethod_Show_(Greeter_method_names[1], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}
...
::grpc::Status Greeter::Stub::Show(::grpc::ClientContext* context, const ::helloworld::ShowRequest& request, ::helloworld::ShowResponse* response) {
  return ::grpc::internal::BlockingUnaryCall(channel_.get(), rpcmethod_Show_, context, request, response);
}

::grpc::ClientAsyncResponseReader< ::helloworld::ShowResponse>* Greeter::Stub::AsyncShowRaw(::grpc::ClientContext* context, const ::helloworld::ShowRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::helloworld::ShowResponse>::Create(channel_.get(), cq, rpcmethod_Show_, context, request, true);
}

::grpc::ClientAsyncResponseReader< ::helloworld::ShowResponse>* Greeter::Stub::PrepareAsyncShowRaw(::grpc::ClientContext* context, const ::helloworld::ShowRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::helloworld::ShowResponse>::Create(channel_.get(), cq, rpcmethod_Show_, context, request, false);
}
...
Greeter::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< Greeter::Service, ::helloworld::ShowRequest, ::helloworld::ShowResponse>(
          std::mem_fn(&Greeter::Service::Show), this)));
}
...
::grpc::Status Greeter::Service::Show(::grpc::ServerContext* context, const ::helloworld::ShowRequest* request, ::helloworld::ShowResponse* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
